...
public class FolderAdaptiveIcon extends CustomAdaptiveIconDrawable {
    ...
    public static @Nullable FolderAdaptiveIcon createFolderAdaptiveIcon(
        ...
        // Do not clip the folder drawing since the icon previews extend outside the
        // background.
        Path mask = new Path();
        mask.addRect(-shift, -shift, requestedSize + shift, requestedSize + shift,
                Direction.CCW);

        // Initialize the actual draw commands on the UI thread to avoid race conditions
        // with
        ...
        // Only convert foreground to a bitmap as it can contain multiple draw commands.
        // Other
        ...
        // Do not use PictureDrawable as it moves the picture to the canvas bounds,
        // whereas we want
        // to draw it at (0,0)
