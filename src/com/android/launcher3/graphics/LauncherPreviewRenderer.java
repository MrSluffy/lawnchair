...
public class LauncherPreviewRenderer extends ContextWrapper
    ...
    public LauncherPreviewRenderer(Context context,
        ...
        BaseIconFactory iconFactory = new BaseIconFactory(context, mIdp.fillResIconDpi, mIdp.iconBitmapSize) {
        };
        ...
        mWorkspaceItemInfo.contentDescription = mWorkspaceItemInfo.title = context
                .getString(R.string.label_application);
    ...
    private PointF getAppWidgetScale(@Nullable ItemInfo itemInfo) {
        ...
        // When the setup() is called for the LayoutParams, insets are added to the
        // width
        // and height of the view. This is not accounted for in WidgetSizes and is
        // handled
        // here.
