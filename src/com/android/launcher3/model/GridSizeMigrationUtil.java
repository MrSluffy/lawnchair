...
public class GridSizeMigrationUtil {
     ...
     * {@link LauncherSettings.Favorites#PREVIEW_TABLE_NAME}, run grid size
     * migration from the
     * former to the later, then use the later table for preview.
     *
     * Similarly when doing the actual grid migration, the former grid option's
     * table
     * {@link LauncherSettings.Favorites#TABLE_NAME} is copied into the new grid
     * option's
     * {@link LauncherSettings.Favorites#TMP_TABLE}, we then run the grid size
     * migration algorithm
