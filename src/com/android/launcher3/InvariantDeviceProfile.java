...
public class InvariantDeviceProfile {
        ...
        // UI thread.
        public static final MainThreadInitializedObject<InvariantDeviceProfile> INSTANCE = new MainThreadInitializedObject<>(
                        InvariantDeviceProfile::new);
        ...
        // Used for arrays to specify different sizes (e.g. border spaces, width/height)
        // in different
        // constraints
        ...
        /**
         * Number of icons inside the hotseat area that is stored in the database. This
         * is greater than
         * or equal to numnShownHotseatIcons, allowing for a seamless transition between
         * two hotseat
        ...
        public InvariantDeviceProfile(Context context, Display display) {
                ...
                // Get the display info based on default display and interpolate it to existing
                // display
                Info defaultInfo = DisplayController.INSTANCE.get(context).getInfo();
                @DeviceType
                int defaultDeviceType = getDeviceType(defaultInfo);
                ...
                @DeviceType
                int deviceType = getDeviceType(myInfo);
                ...
                DisplayOption result = new DisplayOption(defaultDisplayOption.grid)
                                .add(myDisplayOption);
                result.iconSizes[INDEX_DEFAULT] = defaultDisplayOption.iconSizes[INDEX_DEFAULT];
        ...
        /**
         * Reinitialize the current grid after a restore, where some grids might now be
         * disabled.
         */
        ...
        private String initGrid(Context context, String gridName, DeviceProfileOverrides.DBGridInfo dbGridInfo) {
                ...
                ArrayList<DisplayOption> allOptions = getPredefinedDeviceProfiles(context, gridName, deviceType,
                                RestoreDbTask.isPending(context));
                DisplayOption displayOption = invDistWeightedInterpolate(displayInfo, allOptions, deviceType);
        ...
        private void initGrid(Context context, Info displayInfo, DisplayOption displayOption,
                ...
                numDatabaseAllAppsColumns = deviceType == TYPE_MULTI_DISPLAY
                                ? closestProfile.numDatabaseAllAppsColumns
                                : closestProfile.numAllAppsColumns;
                ...
                // Lawnchair ignores partner overrides and allows the user to customize the grid
                // themselves
                ...
                for (WindowBounds bounds : displayInfo.supportedBounds) {
                        ...
                        // Wallpaper size should be the maximum of the all possible sizes Launcher
                        // expects
                        ...
                        float parallaxFactor = dpiFromPx(Math.min(displayWidth, displayHeight),
                                        displayInfo.getDensityDpi()) < 720
                                                        ? 2
                                                        : wallpaperTravelToScreenWidthRatio(displayWidth,
                                                                        displayHeight);
                        defaultWallpaperSize.x = Math.max(defaultWallpaperSize.x,
                                        Math.round(parallaxFactor * displayWidth));
                }
        ...
        public static List<GridOption> parseAllGridOptions(Context context) {
                Info defaultInfo = DisplayController.INSTANCE.get(context).getInfo();
                @DeviceType
                int deviceType = getDeviceType(defaultInfo);
        ...
        private void applyPartnerDeviceProfileOverrides(Context context, DisplayMetrics dm) {
                ...
                try {
                        ...
                        if (iconSizePx > 0) {
                                this.iconSize[InvariantDeviceProfile.INDEX_DEFAULT] = Utilities.dpiFromPx(iconSizePx,
                                                dm.densityDpi);
                        }
        ...
        private static DisplayOption invDistWeightedInterpolate(
                ...
                Collections.sort(points, (a, b) -> Float.compare(dist(width, height, a.minWidthDps, a.minHeightDps),
                ...
                // Since the bitmaps are persisted, ensure that all bitmap sizes are not larger
                // than
        ...
        private static float wallpaperTravelToScreenWidthRatio(int width, int height) {
                ...
                // At an aspect ratio of 16/10, the wallpaper parallax effect should span 1.5 *
                // screen width
                // At an aspect ratio of 10/16, the wallpaper parallax effect should span 1.2 *
                // screen width
                // We will use these two data points to extrapolate how much the wallpaper
                // parallax effect
        ...
        public static final class GridOption {
                ...
                private static final int DEVICE_CATEGORY_ALL = DEVICE_CATEGORY_PHONE | DEVICE_CATEGORY_TABLET
                ...
                public GridOption(Context context, AttributeSet attrs) {
                        ...
                        inlineNavButtonsEndSpacing = a.getResourceId(
                        ...
                        int inlineForRotation = a.getInt(R.styleable.GridDisplayOption_inlineQsb,
                                        DONT_INLINE_QSB);
                        inlineQsb[INDEX_DEFAULT] = (inlineForRotation
                                        & INLINE_QSB_FOR_PORTRAIT) == INLINE_QSB_FOR_PORTRAIT;
                        inlineQsb[INDEX_LANDSCAPE] = (inlineForRotation
                                        & INLINE_QSB_FOR_LANDSCAPE) == INLINE_QSB_FOR_LANDSCAPE;
                        inlineQsb[INDEX_TWO_PANEL_PORTRAIT] = (inlineForRotation
                                        & INLINE_QSB_FOR_TWO_PANEL_PORTRAIT) == INLINE_QSB_FOR_TWO_PANEL_PORTRAIT;
                        inlineQsb[INDEX_TWO_PANEL_LANDSCAPE] = (inlineForRotation
                                        & INLINE_QSB_FOR_TWO_PANEL_LANDSCAPE) == INLINE_QSB_FOR_TWO_PANEL_LANDSCAPE;
                        ...
                        switch (deviceType) {
                                ...
                                case TYPE_MULTI_DISPLAY:
                                        return (deviceCategory
                                                        & DEVICE_CATEGORY_MULTI_DISPLAY) == DEVICE_CATEGORY_MULTI_DISPLAY;
                                default:
                                        return false;
                        }
                }
        ...
        static final class DisplayOption {
                ...
                DisplayOption(GridOption grid, Context context, AttributeSet attrs) {
                        ...
                        iconSizes[INDEX_DEFAULT] = a.getFloat(R.styleable.ProfileDisplayOption_iconImageSize, 0);
                        iconSizes[INDEX_LANDSCAPE] = a.getFloat(R.styleable.ProfileDisplayOption_iconSizeLandscape,
                        ...
                        textSizes[INDEX_DEFAULT] = a.getFloat(R.styleable.ProfileDisplayOption_iconTextSize, 0);
                        textSizes[INDEX_LANDSCAPE] = a.getFloat(R.styleable.ProfileDisplayOption_iconTextSizeLandscape,
                                        textSizes[INDEX_DEFAULT]);
                        textSizes[INDEX_TWO_PANEL_PORTRAIT] = a.getFloat(
                                        R.styleable.ProfileDisplayOption_iconTextSizeTwoPanelPortrait,
                                        textSizes[INDEX_DEFAULT]);
                        textSizes[INDEX_TWO_PANEL_LANDSCAPE] = a.getFloat(
