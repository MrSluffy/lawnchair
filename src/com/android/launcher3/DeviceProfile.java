...
public class DeviceProfile {
    ...
    DeviceProfile(Context context, InvariantDeviceProfile inv, Info info, WindowBounds windowBounds,
        ...
        // AllApps height calculation depends on updated c
            
            
            .dimen.bottom_shee
            seHandleHeigh
            ppsCellHeightPx
            top, contentHeight - targetContentHeight);
            allAppsShiftRange = heightPx - allA
     ...
     * mDotRendererWorkSpace = createDotRenderer(context, iconSizePx,
     * dotRendererCache);
     * mDotRendererAllApps = createDotRenderer(context, allAppsIconSizePx,
     * dotRendererCache);
     * }
     * 
     ...
     *          if (renderer == null) {
     *          renderer = new DotRenderer(size, getShapePath(context,
     *          DEFAULT_DOT_SIZE),
     *          DEFAULT_DOT_SIZE);
     ...
     * 
     *          /**
     *          QSB width is always calculated because when in 3 button nav the
     *          width doesn't follow the
    ...
    public Builder toBuilder(Context context) {
        WindowBounds bounds = new WindowBounds(
                widthPx, heightPx, availableWidthPx, availableHeightPx, rotationH
     * nt);
    ...
    public DeviceProfile getMultiWindowProfile(Context context, WindowBounds windowBounds) {
        ...
        if (appWidgetScaleX != 1 || appWidgetScaleY != 1) {
            ...
            profile = profile.toBuild .setViewScaleProvider(i -> p)
                    .build();
        }
 ...
 ateAllAppsContainerWidth(Resources res) {
     ...
     * 
            ...
            if (cellHeightPx < cellContentHeight) {
                // If cellHeight n // bigger.
                orders = inv.numRows - 1;
    ...
    private void updateAllAppsIconSize(float scale, Resources res) {
        ...
        if (isScalableGrid) {
            ...
            float invIconSizeDp = inv.allAp vIconTextSizeSp = inv.allAppsIconTextSize[mTypeIndex];
            allAppsIconSizePx = Ma conTextSizePx = (int) 
                    blePaddingPx =
                            PixelSize(R.dimen.all_apps_icon_drawable_padding);
    ...
    private void updateAvailableFolderCellDimensions(Resources res) {
        ...
        // For usability we can't have the folder use the whole width of the
     * screen
     ...
     * 
        ...
        float scaleX = contentMaxWidth / cont 
    ...
    pxFromSp(inv.iconTextSize[mTypeIndex], mMetrics, scale);
     ...
     * 
            ...
            folderContentPaddingTop = roundPxValueFromFloat(folderContentPaddin
     * Top * scale);
            folderContentPaddingLeftRight =
                    res.getDimensionPixelSize(R.dimen.folder_content_padding_left_right);
            folderFooterHeightPx =
                    roundPxValueFromFloat(
                            res.getDimensionPixelSize(R.dimen.fol
                er_footer_height_default)
                                    * scale);
    ...
    public
     *  Point getCellSize(Point result) {
     * 
        if (result == null) {
            result = new Point();
        }
     ...
     *
     * <p>This is the height of a Work 
    ...
    public Rect getHotseatLayoutPadding(Context context) {
        ...
        if (isVerticalBarLayout()) {
            ...
            int paddingTop = Math.max((int) (mInsets.top + cellLayoutPaddingPx.t
     * p
                    - diffOverlapFactor), 0);
     ...
     * 
            ...
            if (hotseatBarEndOffset > 0) {
                ...
                endSpacing = availableWidthPx - hotseatWidth - startSpacing + hotsea
     * BorderSpace;
            } else {
                startSpacing = (availableWidthPx - hotseatWidth) / 2;
                endSpacing = startSpacing;
            } tSpacing += getAdditionalQsbSpace();
    ...
    /**
     * 
     * Returns the number of pixels the hotseat is translated from the bottom of
     * the screen.
     */
     ...
     * 
        ...
        writer.println(prefix + pxToDpStr("stashedTaskbarHeight", stashedTaskbarH
         * ight));
         ...
         *         
        wr         ter.println(prefix + pxToDpStr("workspaceTopPadding", workspaceTopPadding));
        ...
        efix + pxToDpStr("getWorkspaceSpringLoadScale()",
